        ...
        <div class="container"> <a href="<?php echo e(route('home')); ?>" class="navbar-brand mb-0 h1"><i
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-6 col-md-auto"><a href="<?php echo e(route('employees.index')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel-framework\resources\views/profile.blade.php ENDPATH**/ ?>