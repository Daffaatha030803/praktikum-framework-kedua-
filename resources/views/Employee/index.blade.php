...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container"> <a href="{{ route('home') }}" class="navbar-brand mb-0 h1"><i
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <hr class="d-lg-none text-white-50"> <a href="{{ route('profile') }}"
    ...
    <div class="container mt-4">
        <div class="row mb-0">
            ...
            <div class="col-lg-3 col-xl-2">
                <div class="d-grid gap-2"> <a href="{{ route('employees.create') }}" class="btn btn-primary">Create
                        Employee</a> </div>
            </div>
        </div>
        <hr>
            ...
            <table class="table table-bordered table-hover table-striped mb-0 bg-white">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>20</td>
                        <td>
                            <div class="d-flex"> <a href="{{ route('employees.show', ['employee' => 1]) }}"
                    ...
                    <tr>
                        ...
                        <td>25</td>
                        <td>
                            <div class="d-flex"> <a href="{{ route('employees.show', ['employee' => 2]) }}"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a> <a
                    ...
                    <tr>
                        ...
                        <td>23</td>
                        <td>
                            <div class="d-flex"> <a href="{{ route('employees.show', ['employee' => 3]) }}"
                                    class="btn btn-outline-dark btn-sm me-2"><i class="bi-person-lines-fill"></i></a> <a
